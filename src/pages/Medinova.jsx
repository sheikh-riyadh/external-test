...
import MedinovaTable from "../components/pages/Medinova/MedinovaTable";
import Modal from "../components/modals/Modal";
import MedinovaForm from "../components/pages/Medinova/MedinovaForm";
    ...
    <div>
      <div className="p-5 flex flex-col gap-5">
        <div className="grid xl:grid-cols-2">
          <span className="font-bold text-xl text-primary uppercase">{`Medinova test`}</span>
        ...
        <div className="bg-card border border-border-primary rounded-sm overflow-hidden">
          <MedinovaTable search={searchValue} />
        </div>
      </div>
      {isModalOpen && (
        <Modal
